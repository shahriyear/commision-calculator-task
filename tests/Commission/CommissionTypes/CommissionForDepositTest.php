 ...
 */
class CommissionForDepositTest extends TestCase
{
    /**
     * @var CommissionForDeposit
     */
    private $type;
    ...
    public function setUp()
    {
        ...
        $singleTransaction = $transactionCollections->getTransactions()[3];
        $this->type = new CommissionForDeposit($singleTransaction, $currencyCollections, $transactionCollections);
    }
