 ...
 */
class CommissionForBusinessWithdrawTest extends TestCase
{
    /**
     * @var CommissionForBusinessWithdraw
     */
    private $type;
    ...
    public function setUp()
    {
        ...
        $singleTransaction = $transactionCollections->getTransactions()[4];

        $this->type = new CommissionForBusinessWithdraw($singleTransaction, $currencyCollections, $transactionCollections);
    }
